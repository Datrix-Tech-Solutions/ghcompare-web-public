export const helpInfo = {
  coverDetailsHelp:  {
        ...
        duration: "This represents the start and end dates of the insurance contract, dictating the duration of coverage and the obligations and benefits associated with the policy"
    },
 vehicleDetailsHelp : {
        vehicleUse: "Tell us if your vehicle is used privately or for commercial purposes",
        riskType: "This refers to the classification of the insured vehicle based on its make, model, and other characteristics. The type of vehicle you are insuring can have a significant impact on your insurance premium and the coverage options available",
        seats: "This refers to the total seating capacity of the insured vehicle, specifically the number of passenger seats, excluding the driver's seat. This information is essential for insurance companies when determining insurance premiums and assessing the risk associated with the vehicle.",
        amountInsured: "This refers to the maximum coverage limit or the total monetary value that an insurance policy will pay out in the event of a covered loss or claim related to your insured vehicle. In other words, it is the maximum amount of money the insurance company will provide to cover the costs associated with specific events, such as accidents, theft, or damage to your vehicle."
 }
}